    ...
    <div className="h-full w-full border-t flex items-center justify-between px-4 bg-[#F7F3EF]">
      ...
      <div className="flex items-center h-16 w-full bg-muted/50 p-4">
        <a
          ...
          className="ml-auto"
        >
          <button className="bg-pink-500 text-white px-4 py-2 rounded-lg font-semibold text-sm hover:bg-pink-600 min-w-[150px] max-w-full min-h-[40px] max-h-full whitespace-normal break-words">
